/**
 * @file Sound.ino
 * @brief Exhaustive test and demonstration of MiP's sound playback and volume control.
 *
 ...
 *   - sound.beginList()
 *   - sound.addEntryToList(MiPSoundIndex sound, uint16_t delayTime, MiPVolume volume)
