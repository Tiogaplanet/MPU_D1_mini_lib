...
class MiP_Weight {
 public:
  /**
   * @brief MiP protocol command byte used to request the current payload weight.
   *
   ...
   * otherwise performs a direct query with automatic retries on communication error.
   *
